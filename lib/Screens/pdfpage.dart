...
class _PdfState extends State<Pdf> {
  ...
  genratePdf() async {
    final ByteData bytes = await rootBundle.load(
        'lib/Assets/e-commerce-logo-with-pointer-and-shopping-bag-free-vector.jpg');
    final Uint8List byteList = bytes.buffer.asUint8List();
    final ByteData bytes1 =
        await rootBundle.load('lib/Assets/Example-QR-code.webp');
    ...
    // var a = await rootBundle.load(
    //     'lib/Assets/e-commerce-logo-with-pointer-and-shopping-bag-free-vector.jpg');
    // Uint8List data = (await rootBundle.load(
    //         'lib/Assets/e-commerce-logo-with-pointer-and-shopping-bag-free-vector.jpg'))
    //     .buffer
    //     .asUint8List();
    ...
    //     await rootBundle.load('lib/Assets/Example-QR-code.webp');
    // final Uint8List byteList = bytes.buffer.asUint8List();
    // final ByteData bytes1 = await rootBundle.load(
    //     'lib/Assets/e-commerce-logo-with-pointer-and-shopping-bag-free-vector.jpg');
    // final Uint8List byteList1 = bytes1.buffer.asUint8List();
    pdf.addPage(
      Pw.Page(
